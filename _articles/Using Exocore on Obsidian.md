...
If you're setting up your exocore for the first, first follow [[installation-instructions|steps 1 and 2 here]] and then come back.

## 1. Clone your repo and set to ssh
First, download [Github Desktop](https://desktop.github.com/) if you don't already have it.

Open the program and follow the instructions to sign in to your Github accountn then click `Current Repository` at the top left, then `Add > Clone Repository...`
...
In `Settings > Daily Notes` set the `New File Location` to `_daily`, and set the template file location to `other/_templates/_daily`

![[Screen Shot 2022-09-20 at 9.09.09 PM.png]]
...
![[Screen Shot 2022-09-19 at 8.03.44 PM.png]]
...
![[Screen Shot 2022-09-05 at 1.21.14 PM.png]]
